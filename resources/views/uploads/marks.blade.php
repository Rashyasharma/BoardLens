...
@section('title', 'Upload Component Marks - Cambridge Exam Portal')
@section('page-title', 'Upload Component Marks')
...
<div class="grid grid-cols-12 gap-8">
    ...
    <div class="col-span-12 lg:col-span-4 space-y-6">
        <div class="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
            <h3 class="text-lg font-bold text-slate-800 tracking-tight">Upload Marks Spreadsheet</h3>
            <p class="text-sm text-slate-500 mt-1">Upload component marks for a subject and series.</p>

            <form method="POST" action="{{ route('uploads.marks.store') }}" enctype="multipart/form-data" class="space-y-5 mt-6">
                @csrf
                ...
                <div>
                    ...
                    <select name="subject_id" required class="w-full px-3 py-2.5 border border-slate-200 rounded-xl bg-slate-50 text-slate-700 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                ...
                <div>
                    ...
                    <input type="file" name="marks_file" required accept=".csv,.xlsx,.xls"
            ...
            <div class="mt-4 overflow-x-auto text-[11px] font-mono border border-slate-800 rounded-xl bg-slate-950 p-3">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-slate-900/60">
                        <tr>
                            <td class="py-1">A</td>
                            <td class="text-slate-300">candidate_number</td>
                            <td class="text-emerald-400">CN001</td>
                        </tr>
                        <tr>
                            <td class="py-1">B</td>
                            <td class="text-slate-300">candidate_name</td>
                            <td class="text-emerald-400">Alice Smith</td>
                        </tr>
                        <tr>
                            <td class="py-1">C</td>
                        ...
                        <tr>
                            <td class="py-1">D</td>
                            <td class="text-slate-300">component_code</td>
                            <td class="text-emerald-400">P2</td>
                        </tr>
                        <tr>
                            <td class="py-1">E</td>
                            <td class="text-slate-300">obtained_marks</td>
                            <td class="text-emerald-400">55.5</td>
                        </tr>
                        <tr>
                            <td class="py-1">F</td>
                            <td class="text-slate-300">total_marks</td>
                            <td class="text-emerald-400">70</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    <div class="col-span-12 lg:col-span-8 bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden flex flex-col justify-between">
        <div>
            <div class="px-6 py-5 border-b border-slate-200 bg-slate-50/50">
                <h3 class="text-lg font-bold text-slate-800">Recent Marks Uploads</h3>
                <p class="text-sm text-slate-500 mt-0.5">Logs of recently imported component marks spreadsheets</p>
            </div>
                        ...
                        @forelse($uploadHistory as $upload)
                            <tr class="hover:bg-slate-50/60 transition duration-150">
                                ...
                                <td class="py-4 px-6 text-slate-500 font-semibold">
                                    {{ $upload->subject ? $upload->subject->subject_name : 'N/A' }}
                                </td>
