...
$r = $db->query("
    SELECT cm.obtained_marks, cm.total_marks, s.subject_code, s.subject_name, es.series_code, cand.candidate_name, cm.component_id, c.component_code, c.component_name, c.component_label
