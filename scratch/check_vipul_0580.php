...
$r = $db->query("
    SELECT c.component_code, c.component_name, c.component_label, c.component_set_id, cs.start_year, cs.end_year, cm.obtained_marks, cm.total_marks, es.series_code 
